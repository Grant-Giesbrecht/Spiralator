...
def create_chip(tlin_width:float, model_str:str):
	...
	chip_d3.insert_text((justify_line, baseline+line_gap*2+2*text_size), f"KIFM_Ser-3_Mdl-{model_str}", selected_font, text_size)
	...
	chip_d3.insert_text((0, -4000), f"<TODO> mm", selected_font, text_size, center_justify=True)
	...
	chip_meister.write(os.path.join("GDS_2", f"KIFM_Ser-3_Mdl-{model_str}.gds"))
