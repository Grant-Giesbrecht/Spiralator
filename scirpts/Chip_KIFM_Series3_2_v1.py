...
def create_chip(tlin_width:float, model_str:str):
	...
	chip_d3.read_conf(os.path.join("designs", "KIFM_Ser3B_v1.json"))
	...
	chip_d3.insert_graphic((1520, -4800), os.path.join("assets", "graphics", "CU.gds"), 350)
	chip_d3.insert_graphic((1200, -4400), os.path.join("assets", "graphics", "NIST.gds"), 1000, read_layer=10)
